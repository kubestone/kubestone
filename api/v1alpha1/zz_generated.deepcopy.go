...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OcpLogtestStatus) DeepCopyInto(out *OcpLogtestStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OcpLogtestStatus.
func (in *OcpLogtestStatus) DeepCopy() *OcpLogtestStatus {
	if in == nil {
		return nil
	}
	out := new(OcpLogtestStatus)
	in.DeepCopyInto(out)
	return out
}
